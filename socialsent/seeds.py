...
POSITIVE_HIST = ['любить', 'добрый', 'хороший', 'спасибо', 'хорошо', 'прекрасный', 'любимый', 'красивый', 'милый', 'нравиться'] 
NEGATIVE_HIST = ['хуй', 'бля', 'тупой', 'сука', 'блять', 'пиздец', 'ненавидеть', 'бесить', 'плохой', 'жопа']
NEUTRAL_HIST = ['быть', 'утро', 'человек', 'сегодня', 'время', 'простой', 'сейчас', 'сообщение', 'жизнь', 'находить']
